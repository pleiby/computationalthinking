...
ex_1_1 = md"""
We seek to show that either
$a \leq \sqrt x \leq \frac x a$ or $\frac x a \leq \sqrt x \leq a$ 

Three cases (assume $x$ and $sqrt x$ are positive):

1. If $a = \sqrt x$ then $\frac x a = \frac x {\sqrt x} = \sqrt x$.

2. If $a < \sqrt x$ then $1/a > 1/{\sqrt x}$ and 
$\frac x a > \frac x {\sqrt x} = \sqrt x$.

3. If $a > \sqrt x$ then $1/a < 1/{\sqrt x}$ and 
$\frac x a < \frac x {\sqrt x} = \sqrt x$.
